...
def run_realtime():
    feeds = [
        ...
        # 台灣來源：負向過濾調查、委員會、報告
        "https://news.google.com/rss/search?q=(工廠+OR+廠房+OR+科技+OR+大樓+OR+中油+OR+台塑)+(火災+OR+爆炸+OR+起火)+-調查+-委員會+-報告+-日前+-回顧+when:12h&hl=zh-TW&gl=TW&ceid=TW:zh-tw"
    ]
